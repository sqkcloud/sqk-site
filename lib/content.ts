...
export const content: Record<Locale, SiteDict> = {
  en: {
    ...
    hero: {
      ...
      title: 'QMedic-led advanced computing for medical imaging, scientific modeling, and hybrid HPC operations.',
      body: 'SQK builds validated, secure, and deployable computing systems for high-trust industries. QMedic is the lead commercial product for CT and MRI workflows, while QTAU, Qukkos, QPINN, QPR, and HPC integration provide the validation, orchestration, refinement, and execution depth required for real deployment.',
      primary: 'Explore Solutions',
      secondary: 'Investor Overview',
    },
    proofPoints: ['QMedic imaging workflow commercialization', 'QTAU validation and scorecards', 'QWIND industrial R&D collaboration', 'IBM Quantum ecosystem engagement', 'MathWorks and HPC collaboration track', 'KISTI joint R&D and tech transfer', 'SNUBH CT/MRI project activity', 'Secure medical AI and PQC roadmap'],
    sections: {
      solutionsEyebrow: 'Solutions',
      solutionsTitle: 'A commercial product supported by reusable platform engines.',
      solutionsBody: 'SQK is organized around one product-led business story. QMedic addresses medical imaging workflows, while QTAU, Qukkos, QPINN, and QPR provide measurable validation, hybrid orchestration, physics-informed modeling, and guarded refinement that can also extend into scientific, industrial, and HPC-heavy domains.',
      technologyEyebrow: 'Technology Platform',
      technologyTitle: 'From validation and refinement to HPC-backed execution.',
      technologyBody: 'SQK connects trust, execution, and domain deployment in one stack. QTAU measures and benchmarks. Qukkos coordinates hybrid workflows. QPINN adds physics-informed reasoning. QPR strengthens reconstruction and refinement. HPC infrastructure carries large-scale execution for imaging, simulation, optimization, and industrial workloads.',
      applicationsEyebrow: 'Applications',
      applicationsTitle: 'Medical imaging first, then expansion into scientific and industrial domains.',
      applicationsBody: 'The first commercial wedge is QMedic in CT and MRI reconstruction, refinement, comparison, and quality governance. The same platform can extend into digital twins, inverse problems, energy and wind-system optimization, and other HPC-intensive workflows where trust and traceability matter.',
      investorsEyebrow: 'Investors',
      investorsTitle: 'Focused commercialization with platform leverage.',
      investorsBody: 'SQK is positioned for a disciplined growth path: QMedic creates the near-term revenue motion, while QTAU, Qukkos, QPINN, QPR, and HPC capabilities compound technical moat, expand domain coverage, and support recurring software and enterprise revenue.',
      ...
      contactTitle: 'Discuss pilots, partnerships, and deployment opportunities with SQK.',
      contactBody: 'Contact SQK regarding QMedic pilots, QTAU validation programs, QPINN and QPR collaborations, quantum-HPC integration, industrial co-development, and investor discussions.',
    },
    aboutPage: {
      eyebrow: 'About SQK',
  ...
  ko: {
    ...
    hero: {
      badge: '고신뢰 산업을 위한 검증형 Quantum-AI-HPC 플랫폼',
      title: 'QMedic을 중심으로 의료영상, 과학컴퓨팅, 하이브리드 HPC 운영을 연결하는 첨단 컴퓨팅 플랫폼.',
      body: 'SQK는 검증 가능하고, 안전하며, 실제 배포가 가능한 컴퓨팅 시스템을 구축합니다. QMedic이 CT·MRI 워크플로우를 위한 핵심 상용 제품이며, QTAU, Qukkos, QPINN, QPR, 그리고 HPC 통합이 검증·오케스트레이션·정제·실행 계층을 구성합니다.',
      primary: '솔루션 보기',
      secondary: '투자자 개요',
    },
    proofPoints: ['QMedic 의료영상 상용화 추진', 'QTAU 검증 및 스코어카드', 'QWIND 산업 R&D 협력', 'IBM Quantum 생태계 연계', 'MathWorks 및 HPC 협력 축', 'KISTI 공동 R&D 및 기술이전', 'SNUBH CT/MRI 프로젝트 활동', '보안형 의료AI 및 PQC 로드맵'],
    sections: {
      solutionsEyebrow: '솔루션',
      solutionsTitle: '하나의 상용 제품과 이를 뒷받침하는 플랫폼 엔진.',
      solutionsBody: 'SQK는 제품군을 산만하게 나열하지 않습니다. QMedic이 의료영상 상용화의 중심에 있고, QTAU·Qukkos·QPINN·QPR은 검증, 하이브리드 실행, 물리기반 모델링, 정제 기술을 제공하며 과학·산업·HPC 도메인으로 확장될 수 있습니다.',
      technologyEyebrow: '기술 플랫폼',
      technologyTitle: '검증과 정제에서 HPC 실행까지 하나의 스택으로 연결합니다.',
      technologyBody: 'QTAU는 측정과 벤치마킹을 담당하고, Qukkos는 하이브리드 워크플로우를 조정하며, QPINN은 물리기반 추론을 제공하고, QPR은 재건 및 정제를 강화합니다. HPC 인프라는 대규모 이미징, 시뮬레이션, 최적화, 산업 분석을 실제로 실행하는 기반입니다.',
      applicationsEyebrow: '적용 분야',
      applicationsTitle: '의료영상에서 시작해 과학·산업 도메인으로 확장합니다.',
      applicationsBody: '첫 상용 진입점은 CT와 MRI 재건, 정제, 비교, 품질 거버넌스를 제공하는 QMedic입니다. 이후 동일한 플랫폼을 디지털 트윈, 역문제, 풍력·에너지 최적화, 제조 시뮬레이션, 기타 HPC 중심 워크플로우로 확장할 수 있습니다.',
      investorsEyebrow: '투자자',
      investorsTitle: '집중된 상용화 전략과 플랫폼 레버리지.',
      investorsBody: 'QMedic이 단기 매출 진입점을 만들고, QTAU·Qukkos·QPINN·QPR·HPC 역량이 기술적 방어력, 도메인 확장성, 반복 매출 구조를 강화합니다.',
      ...
      contactEyebrow: '문의',
      contactTitle: '파일럿, 공동개발, 배포 기회를 SQK와 논의하십시오.',
      contactBody: 'QMedic 파일럿, QTAU 검증 프로그램, QPINN·QPR 공동연구, 양자-HPC 통합, 산업 도메인 공동개발, 투자 협의에 대해 SQK와 직접 논의할 수 있습니다.',
    },
    aboutPage: {
      eyebrow: 'About SQK',
