...
export const content: Record<Locale, SiteDict> = {
  en: {
    ...
    newsCards: [
      { ...shared.newsCards[0], tag: 'Investment', title: 'IBM Ventures invests in SQK', body: 'Official IBM announcement covering strategic investment to accelerate quantum innovation.' },
  ...
  ko: {
    ...
    newsCards: [{ ...shared.newsCards[0], tag: '투자', title: 'IBM Ventures의 SQK  투자', body: '양자 혁신 가속화를 위한 전략적 투자를 다룬 IBM 공식 발표입니다.' }, { ...shared.newsCards[1], tag: '수상', title: 'SuperQuantumStation CES 2024 수상', body: 'Super Quantum Station에 대한 CES Innovation Awards 공식 페이지입니다.' }, { ...shared.newsCards[2], tag: '헬스케어', title: 'QMedic 공개 출시 기사', body: 'SQK의 양자 메디컬 이미징 플랫폼 QMedic을 소개한 공개 기사입니다.' }, { ...shared.newsCards[3], tag: '논문', title: 'QMedic IEEE 논문', body: 'SQK의 QMedic 의료영상 연구와 관련된 IEEE 논문입니다.' }, { ...shared.newsCards[4], tag: '논문', title: 'Qukkos IEEE 논문', body: 'SQK의 오케스트레이션 및 플랫폼 연구와 관련된 IEEE 논문입니다.' }],
    businessModelSection: {
      eyebrow: '비즈니스 모델',
  ...
  fr: {
    ...
    newsCards: [{ ...shared.newsCards[0], tag: 'Investissement', title: 'IBM Ventures investit dans SQK', body: 'Annonce officielle d’IBM sur l’investissement stratégique pour accélérer l’innovation quantique.' }, { ...shared.newsCards[1], tag: 'Prix', title: 'SuperQuantumStation récompensé au CES 2024', body: 'Page officielle des CES Innovation Awards pour Super Quantum Station.' }, { ...shared.newsCards[2], tag: 'Santé', title: 'Article public sur le lancement de QMedic', body: 'Couverture médiatique présentant QMedic et la plateforme d’imagerie médicale quantique de SQK.' }, { ...shared.newsCards[3], tag: 'Publication', title: 'Publication IEEE sur QMedic', body: 'Publication IEEE liée à la recherche d’imagerie médicale QMedic de SQK.' }, { ...shared.newsCards[4], tag: 'Publication', title: 'Publication IEEE sur Qukkos', body: 'Publication IEEE liée à la recherche sur l’orchestration et la plateforme de SQK.' }],
    businessModelSection: {
