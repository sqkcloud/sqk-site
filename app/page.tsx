...
const actionLabels = {
  en: { paper: 'Overview', news: 'Updates', demo: 'Contact' },
  ko: { paper: '개요', news: '소식', demo: '문의' },
  fr: { paper: 'Aperçu', news: 'Actualités', demo: 'Contact' },
} as const;
...
export default function HomePage() {
  ...
  return (
    <main>
      ...
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto grid max-w-[1600px] grid-cols-2 gap-x-6 gap-y-6 px-6 py-8 text-sm lg:grid-cols-4 xl:grid-cols-8 lg:px-8">
      ...
      <section id="solutions" className="mx-auto max-w-[1600px] px-6 py-16 lg:px-8">
      ...
      <section id="applications" className="mx-auto max-w-[1600px] px-6 py-16 lg:px-8">
      ...
      <section id="go-to-market" className="mx-auto max-w-[1600px] px-6 py-16 lg:px-8">
            ...
            {t.roadmapSection.phases.map((phase) => (
              <div key={phase.timeframe} className="rounded-3xl border border-slate-200 bg-slate-50 p-8">
                ...
                <div className="mt-5 space-y-4 text-sm leading-7 text-slate-600">
                  ...
                  <div><span className="font-semibold text-slate-950">Milestone:</span> {phase.kpi}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="investors" className="border-y border-slate-200 bg-white">
        <div className="mx-auto grid max-w-[1600px] gap-12 px-6 py-16 lg:grid-cols-[0.85fr_1.15fr] lg:px-8">
      ...
      <section id="news" className="mx-auto max-w-[1600px] px-6 py-16 lg:px-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-6">
          {t.newsCards.map((item, index) => (
            <a key={item.slug} href={item.href} target="_blank" rel="noreferrer" className={`rounded-3xl border border-slate-200 bg-white p-8 shadow-[0_10px_35px_rgba(15,23,42,0.05)] transition hover:-translate-y-1 ${index === 0 ? 'md:col-span-2 xl:col-span-3 bg-gradient-to-br from-blue-50 via-white to-white' : 'xl:col-span-2'}`}>
              ...
              <div className="mt-6 text-sm font-medium text-blue-700">View source →</div>
            </a>
          ))}
        </div>
      </section>
